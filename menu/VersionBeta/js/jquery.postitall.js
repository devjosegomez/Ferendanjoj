...
;(function ($, $localStorage, window, document, undefined ) {
    ...
    $.fn.postitall.defaults = {
        ...
        posX            : '80px',                   //x coordinate (from left)
        posY            : '0px',                   //y coordinate (from top)
        ...
        style : {
            ...
            fontfamily      : 'Major Mono Display', //Default font
                    ...
                    .append($('<button />', { 'text': 'Hide' })
                        .click(function(e) {
                            ...
                            if(!isNaN(dat)) {
                                ...
                                $('#PIAhideUntilError_' + index).css('color', '#85144b').html('Invalid date!').slideDown();
